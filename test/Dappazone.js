...
describe("Dappazone", () => {
  ...
  describe("Withdrawing", () => {
    ...
    beforeEach(async () => {
      // List a item
      let transaction = await dappazone.connect(deployer).listProduct(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
      await transaction.wait()
      ...
      // Withdraw
      transaction = await dappazone.connect(deployer).withdraw()
      await transaction.wait()
    })
